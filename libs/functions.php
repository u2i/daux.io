...
// If possible, look at the url of the script that was loaded (index.php) and extract just the folder structure.
$base_url = '/';
...
// Stores the entire path that was loaded from the web root.
function url_path() {
...
// Breaks url_path into an array of elements
function url_params() {
...
function get_options() {
	...
	// If no config.json file is present, set up some default options.
	$options = array(
		'title' => "Documentation",
		'tagline' => false,
		'image' => false,
	...
	// Do some sanity checking of the config against the available files.
	// TODO: Implement valid theme check
...
function is_homepage() {
	...
	if (count($url_params) == 1 && $url_params[0] == "") {
		return "true";
	} else {
		return "false";
	}
...
// Returns the path to the root of the currently chosen template.
function template_url($template)
{

	$url = get_base_url() . '/templates/' . $template;
	return $url;
}
